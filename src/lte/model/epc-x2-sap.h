...
public:
  ...
  virtual void RecvRRCCSIRSReport (uint64_t imsi, uint16_t cellId, std::vector<double> csiRSVector) = 0;
...
public:
  ...
  virtual void RecvRRCCSIRSReport (uint64_t imsi, uint16_t cellId, std::vector<double> csiRSVector);
...
template <class C>
void 
EpcX2SpecificEpcX2SapUser<C>::RecvRRCCSIRSReport (uint64_t imsi, uint16_t cellId, std::vector<double> csiRSVector)
{
  m_rrc->DoRecvRRCCSIRSReport (imsi, cellId, csiRSVector);
}
