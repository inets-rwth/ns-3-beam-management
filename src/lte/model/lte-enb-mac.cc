...
void 
EnbMacMemberLteEnbCmacSapProvider::SetCSIRLMResources (uint16_t csiRSPeriodicity, uint16_t csiRSOffset, uint8_t maxCSIRSResources, uint64_t imsi)
{
...
void 
EnbMacMemberLteEnbCmacSapProvider::SetCSIRSFlag (bool csiRSFlag)
{
  //ADDED FOR CSI-RS SCHEDULING IN 5G-NR, SHOULD NOT DO ANYTHING FOR LTE
  NS_LOG_FUNCTION (this);
}
