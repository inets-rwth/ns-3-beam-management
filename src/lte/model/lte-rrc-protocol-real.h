...
private:
  ...
  void DoSendBeamSweepTriggerFromLTECoordinator (uint8_t rnti);

  void DoSendBeamSweepCommandFromLTECoordinator (uint8_t rnti);

  void DoSendUeDeRegistrationCompletedUpdate (uint8_t rnti, uint64_t imsi);
