...
void
LteEnbRrcProtocolIdeal::DoSendBeamSweepTriggerFromLTECoordinator (uint8_t rnti)
{
  // DOES NOTHING FOR LTEENBRRCPROTOCOLIDEAL
}

void 
LteEnbRrcProtocolIdeal::DoSendBeamSweepCommandFromLTECoordinator (uint8_t rnti)
{
  // DOES NOTHING FOR LTEENBRRCPROTOCOLIDEAL
}

void
LteEnbRrcProtocolIdeal::DoSendUeDeRegistrationCompletedUpdate (uint8_t rnti, uint64_t imsi)
{
  // DOES NOTHING FOR LTEENBRRCPROTOCOLIDEAL
}
