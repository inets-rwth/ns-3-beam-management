...
void 
LteEnbPhy::DoSetOptimalGnbBeamForImsi (uint64_t imsi, SfnSf startingSfn, std::vector<uint16_t> optimalBeamIndex, bool isMaxSNRCell)
{
...
void 
LteEnbPhy::DoDeregisterUeFromRRC (uint64_t imsi)
{
...
void 
LteEnbPhy::DoUpdateBeamsTBRLM (uint64_t imsi, std::vector<uint16_t> optimalBeamIndex, SfnSf startingSfn)
{
  // DOES NOTHING FOR LTEENBPHY
}
