...
public:
  ...
  virtual void SetCSIRLMResources (uint16_t csiRSPeriodicity, uint16_t csiRSOffset, uint8_t maxCSIRSResources, uint64_t imsi) = 0;

  virtual void SetCSIRSFlag (bool csiRSFlag) = 0;
