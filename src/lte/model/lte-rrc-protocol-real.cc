...
void
LteEnbRrcProtocolReal::DoSendBeamSweepTriggerFromLTECoordinator (uint8_t rnti)
{
...
void 
LteEnbRrcProtocolReal::DoSendBeamSweepCommandFromLTECoordinator (uint8_t rnti)
{
  Simulator::Schedule (RRC_REAL_MSG_DELAY,
...
void
LteEnbRrcProtocolReal::DoSendUeDeRegistrationCompletedUpdate (uint8_t rnti, uint64_t imsi)
{
  Simulator::Schedule (RRC_REAL_MSG_DELAY,
