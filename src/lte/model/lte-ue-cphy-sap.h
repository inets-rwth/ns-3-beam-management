...
public:
  ...
  virtual void SendSSBRSReport (std::vector<uint16_t> optimalBeamIndexVector, SfnSf startingSfn, uint8_t cellId) = 0;
...
public:
  ...
  virtual void SendSSBRSReport (std::vector<uint16_t> optimalBeamIndexVector, SfnSf startingSfn, uint8_t cellId);
...
template <class C>
void
MemberLteUeCphySapUser<C>::SendSSBRSReport (std::vector<uint16_t> optimalBeamIndexVector, SfnSf startingSfn, uint8_t cellId)
{
  m_owner->DoSendSSBRSBeamReport (optimalBeamIndexVector, startingSfn, cellId);
}
