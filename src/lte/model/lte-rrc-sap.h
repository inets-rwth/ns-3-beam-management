...
public:
  ...
  struct OptimalGnbBeamReport
  {
    ...
    bool isMaxSNRCell;          ///< Boolean indicating whether the cell that the report is sent to has the max SNR
  };
...
public:
  ...
  virtual void SendBeamSweepTriggerFromLTECoordinator (uint8_t rnti) = 0;

  virtual void SendBeamSweepCommandFromLTECoordinator (uint8_t rnti) = 0;

  virtual void SendUeDeRegistrationCompletedUpdate (uint8_t rnti, uint64_t imsi) = 0;
...
public:
  ...
  virtual void SendBeamSweepTriggerFromLTECoordinator (uint8_t rnti);
  virtual void SendBeamSweepCommandFromLTECoordinator (uint8_t rnti);
  virtual void SendUeDeRegistrationCompletedUpdate (uint8_t rnti, uint64_t imsi);
...
template <class C>
void 
MemberLteEnbRrcSapUser<C>::SendBeamSweepTriggerFromLTECoordinator (uint8_t rnti)
{
...
template <class C>
void 
MemberLteEnbRrcSapUser<C>::SendBeamSweepCommandFromLTECoordinator (uint8_t rnti)
{
...
template <class C>
void 
MemberLteEnbRrcSapUser<C>::SendUeDeRegistrationCompletedUpdate (uint8_t rnti, uint64_t imsi)
{
