...
public:
  ...
  void SetSharedParams (std::vector<Vector> enbLocationsSM,
                        ...
                        std::vector<std::vector<int>> losData,
  ...
  std::pair<std::pair<double, double>, std::pair<double, double>> DoGetAoaAod (Vector enbLoc);
private:
  /**
  ...
  Ptr<RxRayData> GetRxRayData(uint32_t traceIndex, Vector enbLocation, bool isTargetEnb) const;
  Ptr<RxRayData> GetRxRayData(uint32_t traceIndex, Vector enbLocation, bool bestPath, bool isTargetEnb) const;
  Ptr<RxRayData> GetPastRxData (uint32_t traceIndex, Vector enbLocation, bool bestPath, bool isTargetEnb, uint32_t count) const;
  bool IsLosBlocked (uint32_t traceIndex, Vector enbLocation) const;
