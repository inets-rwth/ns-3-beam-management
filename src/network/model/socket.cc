...
void
IpTimestampTag::SetIpTimestamp (double timestamp)
{
  m_timestamp = timestamp;
}

double
IpTimestampTag::GetIpTimestamp (void) const
{
  return m_timestamp;
}

TypeId
IpTimestampTag::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::IpTimestampTag")
    .SetParent<Tag> ()
    .SetGroupName("Network")
    .AddConstructor<IpTimestampTag> ()
    ;
  return tid;
}

TypeId
IpTimestampTag::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}

uint32_t
IpTimestampTag::GetSerializedSize (void) const
{
  return sizeof (double);
}

void
IpTimestampTag::Serialize (TagBuffer i) const
{
  i.WriteDouble(m_timestamp);
}

void
IpTimestampTag::Deserialize (TagBuffer i)
{
  m_timestamp = i.ReadDouble();
}

void
IpTimestampTag::Print (std::ostream &os) const
{
  os << "SO_PRIORITY = " << m_timestamp;
}
...
void
UdpTimestampTag::SetUdpTimestamp (double timestamp)
{
  m_timestamp = timestamp;
}

double
UdpTimestampTag::GetUdpTimestamp (void) const
{
  return m_timestamp;
}

TypeId
UdpTimestampTag::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::UdpTimestampTag")
    .SetParent<Tag> ()
    .SetGroupName("Network")
    .AddConstructor<UdpTimestampTag> ()
    ;
  return tid;
}

TypeId
UdpTimestampTag::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}

uint32_t
UdpTimestampTag::GetSerializedSize (void) const
{
  return sizeof (double);
}

void
UdpTimestampTag::Serialize (TagBuffer i) const
{
  i.WriteDouble(m_timestamp);
}

void
UdpTimestampTag::Deserialize (TagBuffer i)
{
  m_timestamp = i.ReadDouble();
}

void
UdpTimestampTag::Print (std::ostream &os) const
{
  os << "SO_PRIORITY = " << m_timestamp;
}
