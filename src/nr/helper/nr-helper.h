...
public:
  ...
  */
  ...
  void RayTraceModelLoadData (OperationBandInfo *band, uint16_t ueWalkId);
...
private:
  ...
  std::map<uint8_t,std::map<uint8_t, Ptr<ThreeGppSpectrumPropagationLossModel > > > m_raytracing; //!< A map of maps. First key denotes the CC key, the second denotes bwp Id.
