...
void 
NrGnbRrcProtocolIdeal::DoSendBeamSweepTriggerFromLTECoordinator (uint8_t rnti)
{
...
void 
NrGnbRrcProtocolIdeal::DoSendBeamSweepCommandFromLTECoordinator (uint8_t rnti)
{
  // DOES NOTHING FOR NRGNBRRCPROTOCOLIDEAL
}

void 
NrGnbRrcProtocolIdeal::DoSendUeDeRegistrationCompletedUpdate (uint8_t rnti, uint64_t imsi)
{
  // DOES NOTHING FOR NRGNBRRCPROTOCOLIDEAL
}
