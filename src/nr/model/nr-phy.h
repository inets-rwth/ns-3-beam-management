...
public:
  ...
  enum SSBRLMScanScenario
  {
    ScanAllRXDirections,
    ScanBestCSIRLMDirections
  };
  ...
  std::pair<std::pair<double, double>, std::pair<double, double>> GetAodAoaFromSM (Vector enbLoc);
...
protected:
  ...
  std::vector<BeamId> m_beamsTbRLM;   //BEAMS TB Monitored via Radio-Link-Monitoring procedure
  std::vector<std::pair<SfnSfKey, std::pair<BeamId, double>>> m_csiRSTbReported;
  ...
  SSBRLMScanScenario m_ssbRlmScanScenario;
